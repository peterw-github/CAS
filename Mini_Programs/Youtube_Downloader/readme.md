...
download_video.py: Downloads high-quality video/audio from YouTube.

convert_to_wav.py: Batch converts local video files into .wav audio optimized for AI/TTS training (24kHz, 384kbps).
...
Windows: Download & Install Guide (Ensure it is added to your system PATH).
...
Open your terminal or command prompt in the folder containing the scripts.

Install the required Python library for the downloader:
...
Calculation: 24000 Hz * 16-bit depth * 1 channel = 384,000 bps

Note: The script outputs Mono audio to strictly adhere to the 384kbps requirement at 24kHz. Stereo would result in 768kbps.
